...
- **链接打开方式**（★ v8.1.0）：菜单「打开链接」可选「系统浏览器 / 应用内」，只对本机生效——选应用内则在独立页面打开笔记里的网址，笔记页本身不动（笔记站自身的链接始终在当前窗口切换）
...
- 多端同时编辑冲突时绝不自动覆盖：无实质差异的版本更新自动接受，真实冲突弹条二选一（保留本机 / 使用云端）
...
<details>
<summary>完整更新详情（共 102 个版本）</summary>
