...
test('V1001-D 三 bump 10.0.1 + 双壳逐字节', () => {
  assert.ok(SRC.includes("const APP_VERSION = '10.0.4';"), 'APP_VERSION 应 10.0.1');
  assert.ok(GRADLE.includes('versionCode 1004') && GRADLE.includes('versionName "10.0.4"'), 'gradle 应 1001/10.0.1');
  assert.ok(MCP.includes("version: '10.0.4'"), 'MCP serverInfo 应 10.0.1');
