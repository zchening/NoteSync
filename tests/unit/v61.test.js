...
test('V61-14 版本升格：APP_VERSION 7.0.1 / BUILD_DATE / gradle 701+7.0.1 / README 条目 ≤40 汉字', () => {
  ...
  assert.ok(src.includes("const BUILD_DATE = '2026-09-25';"), 'BUILD_DATE 应更新');
  const gradle = readRel('android/app/build.gradle');
  assert.ok(gradle.includes('versionCode 1011') && gradle.includes('versionName "10.1.1"'), 'gradle 应 931/9.3.1');
