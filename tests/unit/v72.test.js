...
// ═══════════ 源码断言 ═══════════
test('V72-S1 版本三处一致：index 8.0.8 / gradle 808 / MCP serverInfo 8.0.8', () => {
  ...
  assert.ok(MCP_SRC.includes("serverInfo: { name: 'notesync', version: '8.0.8' }"), 'MCP serverInfo 应 8.0.8');
});
