...
// ═══════════ 源码断言 ═══════════
test('V72-S1 版本三处一致：index 8.1.3 / gradle 813 / MCP serverInfo 8.1.3', () => {
  ...
  assert.ok(MCP_SRC.includes("serverInfo: { name: 'notesync', version: '8.1.3' }"), 'MCP serverInfo 应 8.1.3');
});
