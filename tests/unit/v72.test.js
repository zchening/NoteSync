...
// ═══════════ 源码断言 ═══════════
test('V72-S1 版本三处一致：index 7.9.0 / gradle 790 / MCP serverInfo 7.9.0', () => {
  ...
  assert.ok(MCP_SRC.includes("serverInfo: { name: 'notesync', version: '7.9.0' }"), 'MCP serverInfo 应 7.9.0');
});
