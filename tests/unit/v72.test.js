...
// ═══════════ 源码断言 ═══════════
test('V72-S1 版本三处一致：index 8.0.0 / gradle 800 / MCP serverInfo 8.0.0', () => {
  ...
  assert.ok(MCP_SRC.includes("serverInfo: { name: 'notesync', version: '8.0.0' }"), 'MCP serverInfo 应 8.0.0');
});
