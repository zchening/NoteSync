...
// ═══════════ 源码断言 ═══════════
test('V72-S1 版本三处一致：index 8.1.4 / gradle 814 / MCP serverInfo 8.1.4', () => {
  ...
  assert.ok(MCP_SRC.includes("serverInfo: { name: 'notesync', version: '8.1.4' }"), 'MCP serverInfo 应 8.1.4');
});
