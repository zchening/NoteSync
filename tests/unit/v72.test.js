...
// ═══════════ 源码断言 ═══════════
test('V72-S1 版本三处一致：index 8.1.2 / gradle 812 / MCP serverInfo 8.1.2', () => {
  ...
  assert.ok(MCP_SRC.includes("serverInfo: { name: 'notesync', version: '8.1.2' }"), 'MCP serverInfo 应 8.1.2');
});
