...
// ═══════════ 源码断言 ═══════════
test('V72-S1 版本三处一致：index 7.5.0 / gradle 750 / MCP serverInfo 7.5.0', () => {
  ...
  assert.ok(MCP_SRC.includes("serverInfo: { name: 'notesync', version: '7.5.0' }"), 'MCP serverInfo 应 7.5.0');
});
