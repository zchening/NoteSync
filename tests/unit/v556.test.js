...
test('F8 MainActivity assets 兜底 + RemPlugin.cacheInfo + build.gradle/CI 版本号治本', () => {
  ...
  assert.ok(gradle.includes('versionCode 701'), 'build.gradle versionCode 应 bump 为 701（v7.0.1）');
  assert.ok(gradle.includes('versionName "7.0.1"'), 'build.gradle versionName 应 bump 为 7.0.1');
