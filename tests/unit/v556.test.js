...
test('F8 MainActivity assets 兜底 + RemPlugin.cacheInfo + build.gradle/CI 版本号治本', () => {
  ...
  assert.ok(gradle.includes('versionCode 791'), 'build.gradle versionCode 应 bump 为 791（v7.9.1）');
  assert.ok(gradle.includes('versionName "7.9.1"'), 'build.gradle versionName 应 bump 为 7.9.1');
