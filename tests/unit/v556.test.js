...
test('F8 MainActivity assets 兜底 + RemPlugin.cacheInfo + build.gradle/CI 版本号治本', () => {
  ...
  assert.ok(gradle.includes('versionCode 721'), 'build.gradle versionCode 应 bump 为 721（v7.2.1）');
  assert.ok(gradle.includes('versionName "7.2.1"'), 'build.gradle versionName 应 bump 为 7.2.1');
