...
test('F8 MainActivity assets 兜底 + RemPlugin.cacheInfo + build.gradle/CI 版本号治本', () => {
  ...
  assert.ok(gradle.includes('versionCode 710'), 'build.gradle versionCode 应 bump 为 710（v7.1.0）');
  assert.ok(gradle.includes('versionName "7.1.0"'), 'build.gradle versionName 应 bump 为 7.1.0');
