...
test('F8 MainActivity assets 兜底 + RemPlugin.cacheInfo + build.gradle/CI 版本号治本', () => {
  ...
  assert.ok(gradle.includes('versionCode 800'), 'build.gradle versionCode 应 bump 为 800（v8.0.0）');
  assert.ok(gradle.includes('versionName "8.0.0"'), 'build.gradle versionName 应 bump 为 8.0.0');
