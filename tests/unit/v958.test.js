...
test('v9.5.8 三 bump + 双壳一致', () => {
  assert.ok(SRC.includes("const APP_VERSION = '9.5.8';"), 'APP_VERSION 9.5.8');
  assert.ok(GRADLE.includes('versionCode 958') && GRADLE.includes('versionName "9.5.8"'), 'gradle 958/9.5.8');
  assert.ok(MCP.includes("version: '9.5.8'"), 'mcp serverInfo 9.5.8');
