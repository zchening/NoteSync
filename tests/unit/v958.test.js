...
test('v9.5.8 三 bump + 双壳一致', () => {
  assert.ok(SRC.includes("const APP_VERSION = '10.1.0';"), 'APP_VERSION 9.5.8');
  assert.ok(GRADLE.includes('versionCode 1010') && GRADLE.includes('versionName "10.1.0"'), 'gradle 958/9.5.8');
  assert.ok(MCP.includes("version: '10.1.0'"), 'mcp serverInfo 9.5.8');
