...
test('v9.5.6 网页：landing sub=「落笔即心安」、旧功能句 sub 退役、三 bump 到位', () => {
  ...
  assert.ok(SRC.includes("const APP_VERSION = '10.0.4';"), 'APP_VERSION 9.5.6');
  assert.ok(GRADLE.includes('versionCode 1004') && GRADLE.includes('versionName "10.0.4"'), 'gradle 956/9.5.6');
});
