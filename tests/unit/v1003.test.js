...
test('V1003-G 三 bump 10.0.3 + 双壳逐字节', () => {
  assert.ok(SRC.includes("const APP_VERSION = '10.1.3';"), 'APP_VERSION 应 10.0.3');
  assert.ok(GRADLE.includes('versionCode 1013') && GRADLE.includes('versionName "10.1.3"'), 'gradle 应 1003/10.0.3');
  assert.ok(MCP.includes("version: '10.1.3'"), 'MCP serverInfo 应 10.0.3');
